...
<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="row">
            <div class="card card-body"><h5 class="card-title">Create Scripts</h5>
                <form action="{{url('admin/scripts/store')}}" method="post" enctype="multipart/form-data">
                    <div class="position-relative form-group"><label class="">Name</label><input name="meta[name]" type="text" class="form-control"></div>
                    <label class="">Code</label>
                    <textarea name="meta[code]" cols="30" rows="10" class="form-control"></textarea>
                    @csrf
