...
<div class="app-main__outer">
    <div class="app-main__inner">
        ...
        <div class="row">
            <div class="card card-body"><h5 class="card-title">Create Product Categories</h5>
                <form action="{{url('admin/product-categories/store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <textarea name="meta[description]" cols="30" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="position-relative form-group">
